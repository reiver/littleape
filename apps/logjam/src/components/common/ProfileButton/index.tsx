...
export const ProfileButton = forwardRef<any, ProfileButtonProps>(({ children, variant, class: className, ...props }, ref) => {
    return (
        <button
            type="button"
            ref={ref}
            class={clsx('transition rounded-full p-2 w-[40px] h-[40px] flex justify-center items-center', className, {
