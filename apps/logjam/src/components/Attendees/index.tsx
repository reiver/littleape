      ...
      <div class="flex gap-2 items-center truncate">
        ...
        <div class="flex flex-col justify-center truncate">
          <span class="text-gray-1 dark:text-gray-0 truncate">
            <span class="text-bold-12 text-gray-3 dark:text-white-f-9 greatape-attendees-item">
              {participant.name}
            </span>{" "}
          </span>
          ...
          participant.isHost ? (
            ...
            participant.isRecordingTheMeeting == true ? (
              <span class="text-gray-1 dark:text-gray-0 text-regular-12 greatape-attendees-item-role">
      ...
      <div class="flex gap-1 dark:text-gray-0 text-gray-1">
        {participant.isRecordingTheMeeting && (
          <Icon
            class={`${
              currentUser.value.isHost &&
              currentUser.value.userId != participant.userId
                ? "group-hover:hidden"
                : ""
        ...
        {!raisedHand &&
          ...
          !isMobile && (
            <Icon
              class="hidden group-hover:block greatape-attendees-item"
              icon={Check}
              width="25"
              height="25px"
            />
        ...
        <div class="flex w-full justify-between items-center px-2 min-h-[36px] min-w-[36px]">
          <div class="flex justify-center items-center gap-2">
            ...
            <span>
              ...
              {attendeesCount.value > 1 ? "people" : "person"})
            </span>
          </div>
          ...
          {Object.values(attendees.value)
            .sort((a, b) => {
              ...
              if (a.raisedHand) {
                if (b.raisedHand) {
                  aScore +=
                    a.raisedHand.getTime() - b.raisedHand.getTime() > 0
                      ? -1
                      : 1;
                } else {
                  aScore += 1;
              ...
              if (b.raisedHand) {
                if (a.raisedHand) {
                  bScore +=
                    b.raisedHand.getTime() - a.raisedHand.getTime() > 0
                      ? -1
                      : 1;
                } else {
                  bScore += 1;
            ...
            .map((attendee, i) => {
              return (
                <Participant key={attendee.userId} participant={attendee} />
              );
            })}
        </div>
      </div>
