...
import { stopRecording } from "components/Meeting";
      ...
      <Container>
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center">
            <Recording />
            <span className="text-black dark:text-white text-left ml-1">{"Recording"}</span>
          </div>

          {/* Right Section */}
          {meetingStore.currentUser.isRecordingStarted && (
            <div className="flex items-center cursor-pointer" onClick={handleStopRecording}>
              <span className="text-black dark:text-white text-left mr-1">{"Stop Recording"}</span>
              <StopRecording />
            </div>
          )}
        </div>
