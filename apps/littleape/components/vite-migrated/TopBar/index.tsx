...
import { leaveMeeting, sparkRtcSignal } from "components/Meeting";
...
export const TopBar = ({ customStyles }) => {
  ...
  return (
    ...
    >
      <Container>
        <div className="flex justify-between sm:grid grid-cols-12">
          <div className="col-span-3 flex items-center">
            <Logo />
          </div>
          <div className="sm:flex col-span-6 hidden items-center justify-center">
            {state.meetingStatus && (
              <span className="text-black dark:text-white text-center text-bold-14">
