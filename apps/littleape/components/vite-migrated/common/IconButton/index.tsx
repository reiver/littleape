      ...
      <button
        ...
        className={clsx(
          ...
          className,
          {
            ...
            'dark:text-gray-800 text-gray-100 dark:bg-gray-100 hover:dark:bg-gray-300 bg-gray-900 hover:bg-gray-700 disabled:bg-btn-disabled disabled:hover:bg-btn-disabled':
              !variant,
            // nothing variant adds no extra class
          }
        )}
        {...props}
      >
